...
import {setCodeData} from '../reducers/code'
...
class Blocks extends React.Component {
    ...
    componentDidMount() {
        ...
        const generatPythonCode = () => {
            let code = this.ScratchBlocks.Python.workspaceToCode(this.workspace)
            this.ScratchBlocks.svgResize(this.workspace)
            console.log(code, '生成的代码', this)
            this.props.setCodeData(code)

        }
        //监听工作区的代码变化
        this.workspace.addChangeListener(generatPythonCode);
    }
