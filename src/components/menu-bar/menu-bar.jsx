            ...
            >
                    ...
                    <div className={styles.fileGroup}>
                        ...
                        >
                            ...
                            >
                                ...
                                <MenuSection>
                                    <MenuItem onClick={this.props.hideStage}>
                                        <span>{this.props.isHideStage ? "显示舞台" : "隐藏舞台"}</span>
                                    </MenuItem>
                                </MenuSection>
                ...
                <div className={styles.accountInfoGroup}>
                    ...
                    <div className={styles.switchingMode}>
                        ...
                        >实时模式</div>
                        <div className={'upload' === this.state.selectMode ? styles.selected : ''}
                            onClick={this.selectUploadMode}
                        >上传模式</div>
                    </div>
                </div>
