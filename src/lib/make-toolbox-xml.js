...
//新增积木
const addBlocks = function (isInitialSetup, isStage, targetId, colors) {
    return `
    <category
        name="机器人"
        id="addBlocks"
...
const makeToolboxXML = function (isInitialSetup, isStage = true, targetId, categoriesXML = [],
    ...
    const addBlockXML = moveCategory('addBlock') || addBlocks(isInitialSetup, isStage, targetId, colors.addBlock)
